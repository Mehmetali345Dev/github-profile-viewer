<template>
  <div class="bg-gray-900 text-gray-50 flex flex-col items-center min-h-[100vh]">
    <Nav />
    ...
    <div v-else class="w-full h-full md:flex">
      ...
      <div class="mt-8 mb-8 mr-8 flex-grow">
        <h1 class="mb-2 text-left w-full font-bold text-xl">Repositories</h1>
        <div class="grid w-full gap-4 md:grid-cols-2 justify-center">
